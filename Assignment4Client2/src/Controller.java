		...
		public void defineListeners() {			//Method for defining listeners
			...
			employeeFrame.getBtnCreate().addActionListener(new ActionListener() {			//Add actionsListener	
				public void actionPerformed(ActionEvent e) {							
					...
					if (No.equals("") || FirstName.equals("") || LastName.equals("") || JobTitle.equals("") || Address.equals("")) { 	//Error handling. If the user does not fill in all the text fields, an error message will poop up 
